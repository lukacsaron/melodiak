    ...
    <!-- Kommentar eingeben -->
            ...
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" role="form">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control col-md-6" type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22"/>
                </div>

                <hr/>
                <div class="form-group">
                    <label for="email"><?php _e( 'E-Mail', 'understrap' ); ?> <small>( <?php _e( 'Not public.', 'understrap' ); ?> )</small><small class="text-danger">*</small></label>
                    <input class="form-control col-md-6" type="email" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2"/>
                </div>
                <hr/>
                <div class="form-group">
                    <label for="url"><?php _e( 'Website', 'understrap' ); ?></label>
                    <input class="form-control col-md-6" type="url" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" />
                </div>
                <hr/>
                <div class="form-group">
                    <label><?php _e( 'Your Comment', 'understrap' ); ?> <small class="text-danger">*</small></label>
                    <textarea class="form-control col-md-6" name="comment" id="comment" style="width: 100%;" rows="10" tabindex="4"></textarea>
                </div>
                ...
                <div class="form-group  text-center">
                    ...
                    <input class="form-control col-md-6" type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" />
                </div>
